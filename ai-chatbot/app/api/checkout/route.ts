...
export async function POST() {
  try {
    ...
    const body = new URLSearchParams({
      ...
      'line_items[0][price_data][product_data][name]': 'TrocaCopa — Apoiador',
      'line_items[0][price_data][product_data][description]': 'Apoie o projeto e libere as trocas. Pagamento único.',
